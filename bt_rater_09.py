...
df = pd.read_csv("bt_batch_09.csv", encoding="utf-8-sig")

st.set_page_config(page_title="Backtranslation Rating - Rater 09", layout="centered")
st.title("📝 Simplification Back-Translation Evaluation - Rater 09")
...
if st.button("💾 Export Ratings to CSV"):
    pd.DataFrame(ratings).to_csv(f"bt_ratings_rater09.csv", index=False, encoding="utf-8-sig")
